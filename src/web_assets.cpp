...
// See web_assets.h for why these live in a .cpp and why the pages are split.
//
// `const` at namespace scope has internal linkage, so each of these needs an
// explicit `extern` to match the declaration in the header and be linked to
// from web_server.cpp. Without it the definitions here and the declarations
// there refer to different things and the link fails.
//
// PROGMEM is not used: it is a no-op on ESP32, and `const` alone is enough to
// place these in .flash.rodata, which is memory-mapped. Verified in the ELF --
// they sit at 0x3f4xxxxx and cost no RAM.

extern const char kIndexHead[] = R"HTML(<!doctype html><html lang="en"><head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Tilt Simulator</title>
<link rel="icon" href="data:,">
<style>)HTML";

extern const char kIndexMid[] = R"HTML(</style>
...
extern const char kIndexTail[] = R"HTML(</script></body></html>
)HTML";

extern const char kOtaHead[] = R"HTML(<!doctype html><html lang="en"><head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Firmware · Tilt Simulator</title>
<link rel="icon" href="data:,">
<style>)HTML";

// Opens with the page-specific rules, which continue the same <style> element
// the shared stylesheet was just emitted into.
extern const char kOtaTail[] = R"HTML(
...
extern const char kStyleCss[] = R"CSS(
